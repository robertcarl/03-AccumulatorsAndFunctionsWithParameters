...
#            window = rg.RoseWindow(300, 300, 'Window 1')
#
...
#            window = rg.RoseWindow(300, 100, 'window')
#
...
#            Draws all of the objects in that window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When you want to close the window, or open a new window since only one can run at one time
#
